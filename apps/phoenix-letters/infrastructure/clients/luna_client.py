"""
🌙 Luna Client - Connexion robuste au Hub Central (Phoenix Letters)
...
class LunaClient:
    ...
    def __init__(self, token_provider: Callable[[], str], request_id_provider: Optional[Callable[[], str]] = None):
        ...
        logger.info("Luna client initialized (Letters)", luna_hub_url=LUNA_BASE_URL)
    ...
    def check_energy(self, req: CheckRequest) -> CheckResponse:
        ...
        logger.info("Checking energy with Luna Hub (Letters)", 
                   user_id=req.user_id, 
                   action_name=req.action_name,
                   url=url)
    ...
    def consume_energy(self, req: ConsumeRequest) -> ConsumeResponse:
        ...
        logger.info("Consuming energy with Luna Hub (Letters)",
                   user_id=req.user_id,
                   action_name=req.action_name,
        ...
        try:
            ...
            logger.info("Energy consumed successfully (Letters)",
    ...
    def get_narrative(self, user_id: str) -> Dict[str, Any]:
        ...
        logger.info("Getting user narrative from Luna Hub (Letters)", user_id=user_id, url=url)
        ...
        try:
            ...
            logger.info("User narrative retrieved successfully (Letters)", user_id=user_id)
            return data
