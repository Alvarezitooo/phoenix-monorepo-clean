-- ============================================================================
-- 🚀 PHOENIX LUNA HUB V2.0 - MIGRATION SÉCURISÉE
-- Date: 2025-08-27
-- Objectif: Migration enterprise SANS conflits avec l'existant
-- ============================================================================

BEGIN;

SELECT 'Starting Phoenix Luna Hub v2.0 SAFE migration...' as status;

-- ======================
-- 1️⃣ NETTOYAGE PRÉVENTIF
-- ======================

-- Supprimer les vues qui pourraient confluer avec nos tables
DROP VIEW IF EXISTS public.energy_transactions CASCADE;
DROP VIEW IF EXISTS public.energy_purchases CASCADE;
DROP VIEW IF EXISTS public.user_energy CASCADE;
DROP VIEW IF EXISTS public.users_energy CASCADE;

-- ======================
-- 2️⃣ TABLES ENERGY (Core Business)
-- ======================

-- Table energy_transactions (VRAIE TABLE, pas vue)
...
-- Table user_energy (STRING user_id - format Phoenix)
...
-- Table users_energy (compatibility avec code legacy qui utilise ce nom)
...
-- Vue consentements GDPR actuels
...
-- Message de succès
SELECT 'Phoenix Luna Hub v2.0 SAFE migration completed successfully! ✅' as status;
SELECT 'All enterprise tables created without conflicts! 🚀' as final_status;
